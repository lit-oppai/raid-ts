...
<template>
    <div
        class="px-4 py-6 space-y-4 bg-gray-50 rounded-lg"
        :class="{
        ...
        @click="addStep"
        @pointerover="showRequirePopover = true"
        @pointerleave="showRequirePopover = false"
    >
        <div class="flex items-center group-active:text-white">
            ...
            <svg
                v-show="RAIDName === 'RAID5'"
                width="20"
                height="20"
                viewBox="0 0 20 20"
                class="fill-sky-600 group-active:fill-white ml-1"
        ...
        <div class="py-2">
            <div class="mb-1">
                <span
                    class="text-zinc-800 text-xs font-medium font-['Roboto'] group-active:text-white"
                >
                    {{ $t("Security") }}
                </span>
            </div>
            <div class="flex space-x-1">
                <div
                    ...
                    class="flex-grow h-[3px] bg-sky-600 rounded-[1px] group-active:bg-white"
                ></div>
            </div>
            <div class="mt-4 mb-1">
                <span
        ...
        <div class="flex justify-between">
            ...
            <span
                class="text-neutral-400 text-xs font-normal font-['Roboto'] group-active:text-white"
            >
        ...
        <n-popover :show="disable && showRequirePopover" trigger="manual">
            ...
            {{
                $t("At least {num} hard drives are required", {
                    num: currentRaidStrategyInfo.minDisks,
                })
            }}
        </n-popover>
        <div class="flex justify-between">
